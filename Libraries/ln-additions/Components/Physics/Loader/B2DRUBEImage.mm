...
- (id)initWithB2dJsonImage:(b2dJsonImage *)image {
    ...
    if (self) {
        ...
        self.image = [CCSprite spriteWithSpriteFrameName:[NSString stringWithUTF8String:image->name.c_str()]];
        ...
        self.image.scale = image->scale / _attachedBody.world.ptmRatio / self.image.contentSize.height;
        ...
        self.image.position = [_attachedBody.world CGPointFromb2Vec2:_b2_center];
...
- (void)onAddComponent {
    ...
    self.delegate.body = _attachedBody;
}
